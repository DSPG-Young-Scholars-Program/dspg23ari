...
#### The goal of the first part of the project was to use Army documents to create a dataset of officer assignments that could assist the Social and Decision Analytics (SDAD) and other Army analysts in modeling soldier career progression. 

<br>

- **Assigments** are jobs, or positions, a soldier can hold in their branch of the Army.
